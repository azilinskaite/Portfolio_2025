  ...
  return (
    <div className="App">
      ...
      <section className="projects-container" id="work">
        ...
        <Project photo={chaosPhoto} title="Chaos magazine" info="Mock up of a magazine website with functioning music quiz game. Built using external API, JavaScript, CSS & HMTL" />
        <Project photo={cocktailPhoto} title="Bazaar Bab" info="Landing page for a restaurant built using JavaSript, CSS, HTML." />
        <Project photo={chaosPhoto} title="Library App" info="JavaSript project showing CRUD functionality, adding, updating and deleting books in a personal library." />
      </section>
      <Footer/>
    </div>
  );
